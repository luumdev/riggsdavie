...
var Observer = /*#__PURE__*/function () {
  ...
  _proto.init = function init(vars) {
    ...
    lineHeight || (lineHeight = parseFloat(_win$3.getComputedStyle(_body$1).lineHeight) || 22); // note: browser may report "normal", so default to 22.
...
var ScrollTrigger = /*#__PURE__*/function () {
  ...
  _proto.init = function init(vars, animation) {
    ...
    var _vars = vars,
      ...
      markers = "markers" in vars ? vars.markers : _defaults$2.markers,
  ...
  ScrollTrigger.enable = function enable() {
    ...
    if (gsap$1) {
      ...
      if (_body) {
        ...
        _addListener(_win$2, "wheel", _onScroll); // mostly for 3rd party smooth scrolling libraries.
        ...
        _addListener(_body, "touchstart", _passThrough$1); //works around Safari bug: https://gsap.com/forums/topic/21450-draggable-in-iframe-on-mobile-is-buggy/
...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier(scrollFunc, current, end, max) {
  ...
  _getScrollNormalizer = function _getScrollNormalizer(vars) {
    ...
    _fixIOSBug && gsap$1.ticker.add(_passThrough$1); // prevent the ticker from sleeping
...
var FocusLock = /*#__PURE__*/function () {
  function FocusLock(SELECTORS) {
    _classCallCheck2(this, FocusLock);
  ...
  _createClass2(FocusLock, [{
    key: "_documentKeydownHandler",
    value: function _documentKeydownHandler(event_) {
      ...
      if (event_.key === 'Tab' && !event_.shiftKey && activeElement === this._focusableElements[this._focusableElements.length - 1]) {
        event_.preventDefault();
        this._focusableElements[0].focus();
      }
      if (event_.key === 'Tab' && event_.shiftKey && activeElement === this._focusableElements[0]) {
        event_.preventDefault();
...
var header = document.querySelector('[data-component-id="header"]');
var initAnimation = function initAnimation() {
  if (!header) return;
  var showAnim = gsapWithCSS.from(header, {
    yPercent: -100,
    paused: true,
    duration: 0.3
  }).progress(1);
  ...
  gsapWithCSS.fromTo(':root', {
    '--color-background-header': 'hsla(214, 69%, 21%, 0)'
  }, {
    '--color-background-header': 'hsla(214, 69%, 21%, 1)',
    scrollTrigger: {
      trigger: 'body',
      start: 'top -1%',
      scrub: 1,
  ...
  var customColor = header.dataset.theme;
  var blueLogo = header.querySelector('[data-role="blue-logo"]');
  var whiteLogo = header.querySelector('[data-role="white-logo"]');
  if (customColor) {
    var color = getComputedStyle(document.documentElement).getPropertyValue(customColor);
    var defaultColor = getComputedStyle(document.documentElement).getPropertyValue('--changeable-header-color');
    whiteLogo.style.display = 'none';
    blueLogo.style.display = 'inline-flex';
    gsapWithCSS.fromTo(header, {
      '--changeable-header-color': color
    }, {
      '--changeable-header-color': defaultColor,
      duration: 0.01,
      scrollTrigger: {
        trigger: 'body',
        start: 'top -1%',
        ...
        onEnter: function onEnter() {
          whiteLogo.style.display = 'inline-flex';
  ...
  _createClass2(Animate, [{
    ...
    value: function advance(e) {
      ...
      if (this.lerp) this.value = (s = this.value, o = this.to, n = 60 * this.lerp, r = e, function (t, e, i) {
        ...
        this.currentTime += e;
        var _s2 = t(0, this.currentTime / this.duration, 1);
        i = _s2 >= 1;
        var _o = i ? 1 : this.easing(_s2);
    ...
    key: "fromTo",
    value: function fromTo(t, e, _ref6) {
      var _ref6$lerp = _ref6.lerp,
        i = _ref6$lerp === void 0 ? .1 : _ref6$lerp,
        _ref6$duration = _ref6.duration,
        s = _ref6$duration === void 0 ? 1 : _ref6$duration,
        _ref6$easing = _ref6.easing,
        o = _ref6$easing === void 0 ? function (t) {
          return t;
        } : _ref6$easing,
        n = _ref6.onStart,
        r = _ref6.onUpdate;
...
var Dimensions = /*#__PURE__*/function () {
  function Dimensions() {
    ...
    var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      t = _ref7.wrapper,
      e = _ref7.content,
      _ref7$autoResize = _ref7.autoResize,
      i = _ref7$autoResize === void 0 ? !0 : _ref7$autoResize,
      _ref7$debounce = _ref7.debounce,
      s = _ref7$debounce === void 0 ? 250 : _ref7$debounce;
    _classCallCheck2(this, Dimensions);
    _defineProperty2(this, "resize", function () {
      _this5.onWrapperResize(), _this5.onContentResize();
    });
    _defineProperty2(this, "onWrapperResize", function () {
      _this5.wrapper === window ? (_this5.width = window.innerWidth, _this5.height = window.innerHeight) : (_this5.width = _this5.wrapper.clientWidth, _this5.height = _this5.wrapper.clientHeight);
    });
    _defineProperty2(this, "onContentResize", function () {
      _this5.wrapper === window ? (_this5.scrollHeight = _this5.content.scrollHeight, _this5.scrollWidth = _this5.content.scrollWidth) : (_this5.scrollHeight = _this5.wrapper.scrollHeight, _this5.scrollWidth = _this5.wrapper.scrollWidth);
    });
  ...
  _createClass2(Emitter, [{
    ...
    value: function on(t, e) {
      ...
      return (_this$events$t = this.events[t]) !== null && _this$events$t !== void 0 && _this$events$t.push(e) || (this.events[t] = [e]), function () {
        var _this6$events$t;
        _this6.events[t] = (_this6$events$t = _this6.events[t]) === null || _this6$events$t === void 0 ? void 0 : _this6$events$t.filter(function (t) {
          return e !== t;
        });
      };
    }
...
var VirtualScroll = /*#__PURE__*/function () {
  function VirtualScroll(_t2, _ref8) {
    var _this7 = this;
    var _ref8$wheelMultiplier = _ref8.wheelMultiplier,
      _e2 = _ref8$wheelMultiplier === void 0 ? 1 : _ref8$wheelMultiplier,
      _ref8$touchMultiplier = _ref8.touchMultiplier,
      _i2 = _ref8$touchMultiplier === void 0 ? 1 : _ref8$touchMultiplier;
    _classCallCheck2(this, VirtualScroll);
    _defineProperty2(this, "onTouchStart", function (t) {
      var _ref9 = t.targetTouches ? t.targetTouches[0] : t,
        e = _ref9.clientX,
        i = _ref9.clientY;
      _this7.touchStart.x = e, _this7.touchStart.y = i, _this7.lastDelta = {
        x: 0,
        y: 0
      }, _this7.emitter.emit("scroll", {
        deltaX: 0,
        deltaY: 0,
        event: t
      });
    });
    _defineProperty2(this, "onTouchMove", function (t) {
      var _ref10 = t.targetTouches ? t.targetTouches[0] : t,
        e = _ref10.clientX,
        i = _ref10.clientY,
        s = -(e - _this7.touchStart.x) * _this7.touchMultiplier,
        o = -(i - _this7.touchStart.y) * _this7.touchMultiplier;
      _this7.touchStart.x = e, _this7.touchStart.y = i, _this7.lastDelta = {
        x: s,
        y: o
      }, _this7.emitter.emit("scroll", {
    ...
    _defineProperty2(this, "onTouchEnd", function (t) {
      _this7.emitter.emit("scroll", {
        deltaX: _this7.lastDelta.x,
        deltaY: _this7.lastDelta.y,
        event: t
      });
    });
    _defineProperty2(this, "onWheel", function (t) {
      var i = t.deltaX,
        s = t.deltaY,
        o = t.deltaMode;
      i *= 1 === o ? e : 2 === o ? _this7.windowWidth : 1, s *= 1 === o ? e : 2 === o ? _this7.windowHeight : 1, i *= _this7.wheelMultiplier, s *= _this7.wheelMultiplier, _this7.emitter.emit("scroll", {
        deltaX: i,
        deltaY: s,
        event: t
      });
    });
    _defineProperty2(this, "onWindowResize", function () {
      _this7.windowWidth = window.innerWidth, _this7.windowHeight = window.innerHeight;
    });
    this.element = _t2, this.wheelMultiplier = _e2, this.touchMultiplier = _i2, this.touchStart = {
      x: null,
      y: null
...
var Lenis = /*#__PURE__*/function () {
  function Lenis() {
    ...
    var _ref11 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref11$wrapper = _ref11.wrapper,
      t = _ref11$wrapper === void 0 ? window : _ref11$wrapper,
      _ref11$content = _ref11.content,
      e = _ref11$content === void 0 ? document.documentElement : _ref11$content,
      _ref11$wheelEventsTar = _ref11.wheelEventsTarget,
      i = _ref11$wheelEventsTar === void 0 ? t : _ref11$wheelEventsTar,
      _ref11$eventsTarget = _ref11.eventsTarget,
      s = _ref11$eventsTarget === void 0 ? i : _ref11$eventsTarget,
      _ref11$smoothWheel = _ref11.smoothWheel,
      o = _ref11$smoothWheel === void 0 ? !0 : _ref11$smoothWheel,
      _ref11$syncTouch = _ref11.syncTouch,
      n = _ref11$syncTouch === void 0 ? !1 : _ref11$syncTouch,
      _ref11$syncTouchLerp = _ref11.syncTouchLerp,
      r = _ref11$syncTouchLerp === void 0 ? .075 : _ref11$syncTouchLerp,
      _ref11$touchInertiaMu = _ref11.touchInertiaMultiplier,
      l = _ref11$touchInertiaMu === void 0 ? 35 : _ref11$touchInertiaMu,
      h = _ref11.duration,
      _ref11$easing = _ref11.easing,
      a = _ref11$easing === void 0 ? function (t) {
        return Math.min(1, 1.001 - Math.pow(2, -10 * t));
      } : _ref11$easing,
      _ref11$lerp = _ref11.lerp,
      c = _ref11$lerp === void 0 ? !h && .1 : _ref11$lerp,
      _ref11$infinite = _ref11.infinite,
      d = _ref11$infinite === void 0 ? !1 : _ref11$infinite,
      _ref11$orientation = _ref11.orientation,
      p = _ref11$orientation === void 0 ? "vertical" : _ref11$orientation,
      _ref11$gestureOrienta = _ref11.gestureOrientation,
      u = _ref11$gestureOrienta === void 0 ? "vertical" : _ref11$gestureOrienta,
      _ref11$touchMultiplie = _ref11.touchMultiplier,
      m = _ref11$touchMultiplie === void 0 ? 1 : _ref11$touchMultiplie,
      _ref11$wheelMultiplie = _ref11.wheelMultiplier,
      v = _ref11$wheelMultiplie === void 0 ? 1 : _ref11$wheelMultiplie,
      _ref11$autoResize = _ref11.autoResize,
      g = _ref11$autoResize === void 0 ? !0 : _ref11$autoResize,
      _ref11$__experimental = _ref11.__experimental__naiveDimensions,
      S = _ref11$__experimental === void 0 ? !1 : _ref11$__experimental;
    _classCallCheck2(this, Lenis);
    this.__isSmooth = !1, this.__isScrolling = !1, this.__isStopped = !1, this.__isLocked = !1, this.onVirtualScroll = function (_ref12) {
      var t = _ref12.deltaX,
        e = _ref12.deltaY,
        i = _ref12.event;
      if (i.ctrlKey) return;
      ...
      if (_this8.options.syncTouch && s && "touchstart" === i.type && !_this8.isStopped && !_this8.isLocked) return void _this8.reset();
      var n = 0 === t && 0 === e,
        r = "vertical" === _this8.options.gestureOrientation && 0 === e || "horizontal" === _this8.options.gestureOrientation && 0 === t;
      if (n || r) return;
      var l = i.composedPath();
      if (l = l.slice(0, l.indexOf(_this8.rootElement)), l.find(function (t) {
        var e, i, n, r, l;
        return (null === (e = t.hasAttribute) || void 0 === e ? void 0 : e.call(t, "data-lenis-prevent")) || s && (null === (i = t.hasAttribute) || void 0 === i ? void 0 : i.call(t, "data-lenis-prevent-touch")) || o && (null === (n = t.hasAttribute) || void 0 === n ? void 0 : n.call(t, "data-lenis-prevent-wheel")) || (null === (r = t.classList) || void 0 === r ? void 0 : r.contains("lenis")) && !(null === (l = t.classList) || void 0 === l ? void 0 : l.contains("lenis-stopped"));
      })) return;
      if (_this8.isStopped || _this8.isLocked) return void i.preventDefault();
      if (_this8.isSmooth = _this8.options.syncTouch && s || _this8.options.smoothWheel && o, !_this8.isSmooth) return _this8.isScrolling = !1, void _this8.animate.stop();
      i.preventDefault();
      var h = e;
      "both" === _this8.options.gestureOrientation ? h = Math.abs(e) > Math.abs(t) ? e : t : "horizontal" === _this8.options.gestureOrientation && (h = t);
      var a = s && _this8.options.syncTouch,
        c = s && "touchend" === i.type && Math.abs(h) > 5;
      c && (h = _this8.velocity * _this8.options.touchInertiaMultiplier), _this8.scrollTo(_this8.targetScroll + h, Object.assign({
        programmatic: !1
      }, a ? {
        lerp: c ? _this8.options.syncTouchLerp : 1
      } : {
        lerp: _this8.options.lerp,
        duration: _this8.options.duration,
        easing: _this8.options.easing
      }));
    }, this.onNativeScroll = function () {
      if (!_this8.__preventNextScrollEvent && !_this8.isScrolling) {
        var _t3 = _this8.animatedScroll;
        _this8.animatedScroll = _this8.targetScroll = _this8.actualScroll, _this8.velocity = 0, _this8.direction = Math.sign(_this8.animatedScroll - _t3), _this8.emit();
      }
  ...
  _createClass2(Lenis, [{
    ...
    value: function scrollTo(e) {
      ...
      var _ref13 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        i = _ref13$offset === void 0 ? 0 : _ref13$offset,
        _ref13$immediate = _ref13.immediate,
        s = _ref13$immediate === void 0 ? !1 : _ref13$immediate,
        _ref13$lock = _ref13.lock,
        o = _ref13$lock === void 0 ? !1 : _ref13$lock,
        _ref13$duration = _ref13.duration,
        n = _ref13$duration === void 0 ? this.options.duration : _ref13$duration,
        _ref13$easing = _ref13.easing,
        r = _ref13$easing === void 0 ? this.options.easing : _ref13$easing,
        _ref13$lerp = _ref13.lerp,
        l = _ref13$lerp === void 0 ? !n && this.options.lerp : _ref13$lerp,
        h = _ref13.onComplete,
        _ref13$force = _ref13.force,
        a = _ref13$force === void 0 ? !1 : _ref13$force,
        _ref13$programmatic = _ref13.programmatic,
        c = _ref13$programmatic === void 0 ? !0 : _ref13$programmatic;
      if (!this.isStopped && !this.isLocked || a) {
        if (["top", "left", "start"].includes(e)) e = 0;else if (["bottom", "right", "end"].includes(e)) e = this.limit;else {
          ...
          if ("string" == typeof e ? _t4 = document.querySelector(e) : (null == e ? void 0 : e.nodeType) && (_t4 = e), _t4) {
            ...
            var _s3 = _t4.getBoundingClientRect();
            e = (this.isHorizontal ? _s3.left : _s3.top) + this.animatedScroll;
          }
        }
        if ("number" == typeof e) {
          ...
          this.animate.fromTo(this.animatedScroll, e, {
            ...
            lerp: l,
            onStart: function onStart() {
              o && (_this9.isLocked = !0), _this9.isScrolling = !0;
            },
            onUpdate: function onUpdate(t, e) {
              _this9.isScrolling = !0, _this9.velocity = t - _this9.animatedScroll, _this9.direction = Math.sign(_this9.velocity), _this9.animatedScroll = t, _this9.setScroll(_this9.scroll), c && (_this9.targetScroll = t), e || _this9.emit(), e && (_this9.reset(), _this9.emit(), null == h || h(_this9), _this9.__preventNextScrollEvent = !0, requestAnimationFrame(function () {
                delete _this9.__preventNextScrollEvent;
              }));
            }
          });
        }
...
var observer = new MutationObserver(function (mutations) {
  mutations.forEach(function (mutation) {
    if (mutation.type === 'attributes' && mutation.attributeName === 'class') {
      ...
      if (_element.classList.contains('w-editor')) {
        lenis.destroy();
      }
    }
  });
...
var animatingChars = function animatingChars(_ref14) {
  var words = _ref14.words,
    _ref14$start = _ref14.start,
    start = _ref14$start === void 0 ? 'top 70%' : _ref14$start,
    _ref14$opacity = _ref14.opacity,
    opacity = _ref14$opacity === void 0 ? 0 : _ref14$opacity,
    _ref14$y = _ref14.y,
    y = _ref14$y === void 0 ? 30 : _ref14$y,
    _ref14$duration = _ref14.duration,
    duration = _ref14$duration === void 0 ? 0.8 : _ref14$duration;
  words.forEach(function (_char) {
    gsapWithCSS.from(_char, {
      y: y,
      opacity: opacity,
      duration: duration,
      scrollTrigger: {
...
var animatingElements = function animatingElements(_ref15) {
  var elements = _ref15.elements,
    _ref15$start = _ref15.start,
    start = _ref15$start === void 0 ? 'top 70%' : _ref15$start,
    _ref15$opacity = _ref15.opacity,
    opacity = _ref15$opacity === void 0 ? 0 : _ref15$opacity,
    _ref15$y = _ref15.y,
    y = _ref15$y === void 0 ? 30 : _ref15$y,
    _ref15$duration = _ref15.duration,
    duration = _ref15$duration === void 0 ? 0.8 : _ref15$duration;
...
var initAnimate = function initAnimate() {
  var animateTextElements = gsapWithCSS.utils.toArray('[animate-text]');
  var animateTextElementsStart = gsapWithCSS.utils.toArray('[animate-text-start]');
  var animateElements = gsapWithCSS.utils.toArray('[animate-element]');
  var animateElementsStart = gsapWithCSS.utils.toArray('[animate-element-start]');
  animateTextElements.forEach(function (textElement) {
    new SplitType(textElement, {
      types: 'words',
      tagName: 'span'
    });
    var words = textElement.querySelectorAll('.word');
    animatingChars({
      words: words
    });
  });
  animateTextElementsStart.forEach(function (textElement) {
    new SplitType(textElement, {
      types: 'words',
      tagName: 'span'
    });
  ...
  animatingElements({
    elements: animateElements
  });
  animatingElements({
    elements: animateElementsStart,
    start: 'top 100%',
    opacity: -2.5,
    y: 0
  });
...
var initSelect = function initSelect() {
  var selects = _toConsumableArray2(document.querySelectorAll('[data-role="select"]'));
...
window.focusLock = new FocusLock(SELECTORS);
