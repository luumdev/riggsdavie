...
function requireAddAsync() {
  ...
  addAsync = function addAsync(list) {
...
function requirePagination() {
  ...
  var classes$1 = classes,
    events$1 = events,
    List = requireSrc();
  pagination = function pagination(list) {
    var isHidden = false;
    var refresh = function refresh(pagingList, options) {
      ...
      for (var i = 1; i <= pages; i++) {
        ...
        if (is.number(i, left, right, currentPage, innerWindow)) {
          ...
          if (className) {
            classes$1(item.elm).add(className);
          }
          ...
          classes$1(item.elm).add('disabled');
        }
      }
    };
    var is = {
    ...
    return function (options) {
      ...
      events$1.bind(pagingList.listContainer, 'click', function (e) {
...
function requireTemplater() {
  ...
  templater = function templater(list) {
...
function requireFuzzy() {
  ...
  hasRequiredFuzzy = 1;
  fuzzy = function fuzzy(text, pattern, options) {
...
function requireFuzzySearch() {
  ...
  var events$1 = events,
    extend$1 = extend,
    toString$1 = toString,
    getByClass$1 = getByClass,
    fuzzy = requireFuzzy();
  fuzzySearch = function fuzzySearch(list, options) {
    options = options || {};
    options = extend$1({
      location: 0,
      distance: 100,
    ...
    var fuzzySearch = {
      ...
      values: function values(_values, value, searchArgument) {
        if (_values.hasOwnProperty(value)) {
          var text = toString$1(_values[value]).toLowerCase();
    ...
    events$1.bind(getByClass$1(list.listContainer, options.searchClass), 'keyup', list.utils.events.debounce(function (e) {
...
function requireSrc() {
  ...
  hasRequiredSrc = 1;
  var naturalSort = naturalCompare_1,
    getByClass$1 = getByClass,
    extend$1 = extend,
    indexOf = indexOf_1,
    events$1 = events,
    toString$1 = toString,
    classes$1 = classes,
    getAttribute$1 = getAttribute,
    toArray = toArray$1;
  src = function src(id, options, values) {
    var self = this,
      init,
      Item = requireItem()(self),
      addAsync = requireAddAsync()(self),
      initPagination = requirePagination()(self);
    init = {
      start: function start() {
        ...
        self.list = getByClass$1(self.listContainer, self.listClass, true);
...
var List = /*@__PURE__*/getDefaultExportFromCjs(srcExports);
export { List as L };
